        ...
        <div className="header_container sticky top-0 z-20">
            <header className="flex border-b-[1px] h-[86px] bg-white z-10 flex-nowrap w-full relative">
                <div className="flex items-center w-auto">
                    ...
                    <div className="w-[320px] cursor-pointer border-l-[1px] h-full justify-center flex flex-col items-center hover:bg-gray-50">
                        <div className="align-contern-c items-center text-[16px]">
                            <div className="text-black font-extrabold mb-1.5 text-lg">Delivery in 10 minutes</div>
                            <div className="flex flex-row">
                                <div className="text-[13px] text-black font-normal clear-both inline-block overflow-hidden whitespace-nowrap w-auto max-w-[210px] truncate">155-56, Block 16, Part 2, Trilokpuri, New Delhi, Delhi, 110091, India</div>
                                <div className="justify-center items-center flex">
                                    <div className="w-0 border-l-[6px] border-l-transparent border-r-[6px] border-r-transparent border-t-[6px] border-t-black ml-2"></div>
                                </div>
                            </div>
                        </div>
                    </div>
